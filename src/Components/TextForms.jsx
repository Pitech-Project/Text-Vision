    ...
    return (
        <>
            <div id='textarea-container' className={`input-container text-${props.mode === 'light' ? 'dark' : 'light'}`} >
                ...
                <div className="mb-3">
                    <textarea className="form-control" id="myBox" style={{ backgroundColor: props.mode === 'light' ? 'white' : 'gray'}} value={Text} placeholder={"Enter the text here"} rows="6"></textarea>
                </div>
                <div id='buttons-container'>
                    <button id="btn" className="btn btn-primary" >To upper case</button>
                    <button id="btn" className="btn btn-primary">To lower case</button>
                    <button id="btn" className="btn btn-primary">Trim the Text</button>
                    <button type='submit' id="btn" className='btn btn-primary'>Copy Text</button>
                    <button id="btn" className="btn btn-primary"> Reverse Words</button>
                    <button id="btn" className="btn btn-primary">Remove number</button>
                    <button id="btn" className="btn btn-primary">Remove special character</button>
                    ...
                    <div id='style-border'>
                        <div id='style-inner'>
                            <div style={{ padding: "10px", }}>Vowel: <span style={{ color: '#ff992d' }}></span> &nbsp;
                                Consonent:<span style={{ color: '#ff992d' }}> </span></div>
                            <button id="btn" className="btn btn-primary" >Count vowel & consonent</button>
                        </div>
                    </div>

                    <div id='style-border'>
                        <div id='style-inner'>
                            <button id="btn" className="btn btn-primary">Encode text
                            </button>

                            <button id="btn" className="btn btn-primary">Decode text
                            </button>
                        </div>
                    </div>
                    ...
                    <button id="btn" className="btn btn-primary">Texts in Voice</button>

                    <button id="btn" className="btn btn-primary">Clear the text</button>
                </div>

            </div >
            <div id="input-container" className='lastDiv' style={{ color: props.mode === 'light' ? 'GrayText' : 'silver' }}>
                <h2>Your text summery </h2>
                <p id="para" >words andText</p>
                <h4 id="para">Time to read</h4>
            </div>
        </>
    )
}
